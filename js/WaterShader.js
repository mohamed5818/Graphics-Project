...
THREE.ShaderLib['water'] = {
	...
	'	vec3  surfaceNormal = normalize( noise.xzy * vec3( 0.55, 0.2, 0.65 ) );',
		...
		'	vec2 distortion = surfaceNormal.xz * ( 0.001 + 0.3 / distance*0.01 ) * distortionScale*surfaceNormal.xy;',
		...
		'	vec3 scatter = max( 2.5, dot( surfaceNormal, eyeDirection ) - dot( surfaceNormal, sunDirection ) ) * waterColor;',
		'	vec3 albedo;',
		'	albedo = mix( sunColor * diffuseLight *waterColor + scatter*0.5, ( vec3( 0.1 ) + reflectionSample + reflectionSample * specularLight ), reflectance );',
